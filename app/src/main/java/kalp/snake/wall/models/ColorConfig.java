...
public class ColorConfig {
    ...
    public ColorConfig(int foodColor, int snakeColor, int backgroundColor, int buttonsAndFrameColor, int gridColor) {
...
//    factory method to fetch from prefs and also make it default constructor
    public static ColorConfig getFromPrefs(SharedPreferences sharedPreferences, Context context) {
        ...
        return new ColorConfig(foodColor, snakeColor, backgroundColor, buttonsAndFrameColor, gridColor);
    }
